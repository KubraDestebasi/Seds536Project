            ...
            try:
                ...
                if result.multi_hand_landmarks:
                    for hand_landmarks in result.multi_hand_landmarks:
                        ...
                        features = [
                            thumb_pinky_distance,  # Distance between Thumb Tip and Pinky Tip
                            thumb_wrist_angle,     # Angle between Thumb Tip and Wrist
                            *thumb_pinky_vector    # Vector components (X, Y, Z) from Thumb Tip to Pinky Tip
                        ]
...
# Save to .npz files
np.savez("landmark_train_original.npz", data=X_train, labels=y_train)
np.savez("landmark_val_original.npz", data=X_val, labels=y_val)
np.savez("landmark_test_original.npz", data=X_test, labels=y_test)

print("Normalized landmark data saved successfully!")
